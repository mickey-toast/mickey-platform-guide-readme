...
excerpt: >-
  You can search for a current check directly on a Toast POS device using
...
For more information, see [Search using guest or tab name, table or check number](https://doc.toasttab.com/doc/platformguide/adminSearchingGuestChecks.html#adminSearchName) or [Search by reswiping a credit card or by check number](https://doc.toasttab.com/doc/platformguide/adminSearchingGuestChecks.html#adminSearchNumber).
...
For more information, see [Search using other information](https://doc.toasttab.com/doc/platformguide/adminSearchingGuestChecks.html#adminAdvancedSearch).

**Search using guest or tab name, table or check number**

This search option helps you find a check quickly using the guest's first or last name, tab name, or table or check number. To find a check with this feature you must have the **1.1 Table Service Mode**, **1.2 Quick Order Mode**, or **1.4 Payment Terminal Mode** [access permission](https://doc.toasttab.com/doc/platformguide/adminPermissions.html#adminModePermissions).
...
3. Enter the guest's first or last name, tab name, or the table or check number. As you type, the Toast platform searches and shows a list of checks that match the entered characters.
   ...
   Similarly, when you type a letter, the list of open checks updates to show only checks with a first name, last name, or [tab name](https://doc.toasttab.com/doc/platformguide/adminUiOptionsReference.html#configPromptTabName) that starts with that letter.
...
- If you have the [1.9 Edit Other Employees' Orders](https://doc.toasttab.com/doc/platformguide/adminPermissions.html#permissionEditOtherEmployeesOrders) access permission, you can also search for checks opened by other employees: tap the **Overflow menu** (the ⋮ icon) and select **Show all checks**.

**Search by reswiping a credit card or by check number**
...
**Search using other information**
...
To use this feature to search for checks you must have the [3.23 Find Checks](https://doc.toasttab.com/doc/platformguide/adminPermissions.html#permissionFindChecks) access permission.
...
1. Use either a Toast POS device or Toast Web to open **Advanced check search**.
   ...
   - [Access Toast Web](https://doc.toasttab.com/doc/platformguide/adminAccessToastAdminBackend.html) and then select **Finance > Payments > Find checks & issue refund**.
