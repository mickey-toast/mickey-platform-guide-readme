...
excerpt: >-
  As a manager, you can review employee shifts on a Toast POS device. To view
  employee shifts, navigate to Manager Activities, and select Review Employee
  Shifts to open the…
hidden: false
metadata:
  description: >-
...
> 📘 Note
>
> To access the **Review Employee Shifts** screen, you must have **3. Manager > 3.12 Shift Review** permission. For more information about permissions, see [Manager access permissions](https://doc.toasttab.com/doc/platformguide/adminPermissions.html#adminManagerAccessPermissions).
...
> 📘 Note
>
> To access the **Time entries** pane, you must have **3. Manager > 3.14 Edit Time Entries** permission. For more information about permissions, see [Manager access permissions](https://doc.toasttab.com/doc/platformguide/adminPermissions.html#adminManagerAccessPermissions).

You can edit your own shift review or another employee’s using the **Time entries** pane.

![The Time entries pane opened.](https://doc.toasttab.com/doc/media/money-shift-review-time-entries-pane.png)

In the **Time entries**pane, you can complete various actions depending on if the shift is active or closed.
...
- Declare or adjust cash tips. Select the **Declare cash tips** button to open a numerical keypad where you can enter a new numerical value or adjust your cash tips. The total declared cash tips appear below the **Declare cash tips** button. For more information, see [Declaring cash tips](https://doc.toasttab.com/doc/platformguide/platformCompletingShiftReview.html#platformDeclaringCashTips).

   ![The Declare cash tips numerical keypad opened.](https://doc.toasttab.com/doc/media/money-shift-review-time-entries-pane-declare-cash-tips.png)
- Reset your changes
- Save your changes
