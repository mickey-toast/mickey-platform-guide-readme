...
excerpt: >-
  If shift review is required, the following steps must be completed before you
  can end your shift and clock out:
hidden: false
metadata:
  description: >-
    If shift review is required, the following steps must be completed before
    you can end your shift and clock out:
---
...
> 📘 Note
>
> Some jobs may require you to clock in to your shift in order to complete shift review. For more information, see [Requiring shift review](https://doc.toasttab.com/doc/platformguide/platformConfiguringShiftReview.html#platformRequiringShiftReview).
...
**To clock into your shift from the Shift Review screen**
...
For more information about how to clock into your shift from the **Time Clock** screen, see [Clocking In and Out for Shifts and Breaks](https://support.toasttab.com/article/Clocking-In-and-Out-for-Shifts-and-Breaks).
...
**To close your open and unpaid checks**
...
> 
> Employees who must declare cash tips must have the **Tipped?** option checked for their assigned job. For more information, see [UI options settings](https://doc.toasttab.com/doc/platformguide/adminUiOptionsReference.html).
...
> 📘 Note
>
> To allow employees to cash out their credit card tips without having to enter a manager passcode, they must be assigned the **1.13 No Sale** permission. This permission allows employees to make a **No Sale** entry and open a cash drawer without having to complete a transaction. For more information about permissions, see [Access permissions reference](https://doc.toasttab.com/doc/platformguide/adminPermissions.html#adminAddlPosAccessPermissions).

**To reconcile your cash and collect your non-cash tips**
...
The next step in shift review is closing any cash drawer(s) locked to you. This is an optional step that can be configured on the Toast POS device. For more information on how to lock down a cash drawer, see [Lock down a cash drawer](https://doc.toasttab.com/doc/platformguide/adminCashDrawerLockdown.html).
...
**To clock out or clock out and start a new shift**
