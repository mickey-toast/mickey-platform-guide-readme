...
excerpt: >-
  You can accept prepaid credit cards as a form of payment in the Toast
  platform. The way that you accept prepaid credit cards is similar to accepting
  traditional credit cards.…
hidden: false
metadata:
  description: >-
    You can accept prepaid credit cards as a form of payment in the Toast
    platform. The way that you accept prepaid credit cards is similar to
    accepting traditional credit cards.…
---
...
**Initial payment authorization screen**
...
**Payment screen with partial authorization**
