...
excerpt: >-
  If your Toast POS device is offline, you will be unable to complete shift
  review. During offline mode, you are unable to:
hidden: false
metadata:
  description: >-
    If your Toast POS device is offline, you will be unable to complete shift
...
**To complete shift review offline as an employee**
...
**To complete shift review offline as a manager**
...
When the restaurant is back online, the manager can use the **Time Entries** report to [adjust the time entry](https://doc.toasttab.com/doc/platformguide/adminOfflineEmployees.html#adminOfflineTimeEntries) for the employee.

> 📘 Note
>
> Depending on the setting of the [Auto Clock-out](https://doc.toasttab.com/doc/platformguide/adminOfflineEmployees.html#adminOfflineAutoClock) restaurant option, clocked-in employees may be automatically clocked out at the end of the business day.
