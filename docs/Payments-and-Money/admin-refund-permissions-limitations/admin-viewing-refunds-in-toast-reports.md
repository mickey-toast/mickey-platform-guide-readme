...
metadata:
  description: >-
    You can view refund information on receipts, in reports, and in order
    details.
---
...
3. [Locate the check](https://doc.toasttab.com/doc/platformguide/adminIssuingARefund.html#adminToLocateACheckInToastAdminBackend).
...
Payments that are refunded using the custom amount refund type still appear in the [Payments Summary](https://doc.toasttab.com/doc/platformguide/adminViewingRefundsInToastReports.html#adminSalesSummaryPaymentsSummary) table.
