...
hidden: false
metadata:
  description: 'For Toast restaurants, a marketplace facilitator is a business that:'
---
...
If your restaurant uses a Toast API integration that gets information about orders, the order information that you get from Toast APIs includes information about tax amounts remitted on behalf of your restaurant. For more information, see [Marketplace facilitator tax information](https://doc.toasttab.com/doc/devguide/apiMarketplaceFacilitatorTaxInformation.html).

The following sections provide more information about marketplace facilitator tax payments:

- [Tax payment reporting information](https://doc.toasttab.com/doc/platformguide/adminMarketplaceFacilitatorTaxPayments.html#adminMpfTaxPaymentReportingInformation)
- [Tax amounts are aggregated for all items and checks](https://doc.toasttab.com/doc/platformguide/adminMarketplaceFacilitatorTaxPayments.html#adminMpfTaxAmountsAggregated)
- [Marketplace facilitator orders are protected from changes](https://doc.toasttab.com/doc/platformguide/adminMarketplaceFacilitatorTaxPayments.html#adminMpfOrdersProtectedFromChanges)
...
To calculate the amounts used for taxes, refer to the orders API `AppliedTaxRate` object. For more information about this object and how it applies to marketplace facilitators, see [Reviewing marketplace facilitator tax calculations](https://doc.toasttab.com/doc/devguide/apiMarketplaceFacilitatorTaxInformation.html#apiOrdersGetMarketplaceFacilitatorCalculateTax).

For instructions on how to calculate the total marketplace facilitator tax paid for an order, see [Calculating total marketplace facilitator tax paid](https://doc.toasttab.com/doc/devguide/apiMarketplaceFacilitatorTaxInformation.html#apiOrdersGetMarketplaceFacilitatorCalculateTotalTaxPaid).
