...
title: Fixed rates
excerpt: >-
  A fixed tax rate levies the same monetary amount on a menu item, regardless of
  its price. You would use a fixed tax rate for special cases, such as for
  bottle deposits.
hidden: false
metadata:
  description: >-
    A fixed tax rate levies the same monetary amount on a menu item, regardless
    of its price. You would use a fixed tax rate for special cases, such as for
    bottle deposits.
---
