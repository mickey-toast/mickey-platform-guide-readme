...
excerpt: >-
  To create a service charge, you need POS Access > Add/Update Service Charges
  permissions. For more information, see the Access Permission Reference.
hidden: false
metadata:
  description: >-
    To create a service charge, you need POS Access > Add/Update Service Charges
...
To create a service charge, you need **POS Access > Add/Update Service Charges** permissions. For more information, see the [Access Permission Reference](https://doc.toasttab.com/doc/platformguide/adminPermissions.html#adminAddlPosAccessPermissions).

Before you create a service charge that is taxed, configure your tax rates using the **Tax Rates** page. To display the **Tax Rates** page, choose **Menus > Menu management > Tax rates setup**. For more information, see [Taxes overview](https://doc.toasttab.com/doc/platformguide/adminTaxesOverview.html).

### Configuring a new service charge

**To configure a new service charge**

1. [Access Toast Web](https://doc.toasttab.com/doc/platformguide/adminAccessToastAdminBackend.html).
2. Choose **Finance > Related > Settings > Service charges & fees**.
3. On the **Service charges** page, select the **+ Add** button.
4. In the **New Service Charge** page, enter the **Basic** configuration information:
   ...
   ****Target****
   : (Enterprise module only) Select the restaurants in a restaurant group to which this service charge can be applied.
     For information on targets, see [Targets](https://doc.toasttab.com/doc/platformguide/targets.html).

   ****Owner****
   : (Enterprise module only) Select the group level permission that is needed to edit the service charge.
     For information on owners, see [Owners and permissions](https://doc.toasttab.com/doc/platformguide/ownersAndPermissions.html).
...
7. Select **Save** and publish your changes.
...
3. To save the new display sequence for the service charges, select **Done**.
