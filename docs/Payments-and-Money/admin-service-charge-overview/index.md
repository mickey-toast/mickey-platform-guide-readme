...
excerpt: >-
  You can configure service charges that can be optionally added to a check as
  an upcharge. For example, you can configure an open service charge for your
  restaurant to specify a…
hidden: false
metadata:
  description: >-
    You can configure service charges that can be optionally added to a check as
...
Choose **Finance > Related > Settings > Service charges & fees** and select the name of the service charge you want to edit to change its configuration.
