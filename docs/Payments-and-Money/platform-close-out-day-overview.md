...
title: Overview
excerpt: >-
  On the Close Out Day screen, you can view and complete various actions to
  close out your restaurant for the day. The Close Out Day screen displays the
  restaurant’s Z report…
hidden: false
metadata:
  description: >-
    On the Close Out Day screen, you can view and complete various actions to
...
**To view and complete your close out day**
...
2. The **Close Out Day** screen displays steps that can be completed to close out the day. The actions available depend on the status of each step. The steps and their available actions are:
   ...
   - **Mark orders as picked up**: View and mark scheduled orders as picked up. This step is optional and only available if you have enabled **Pick up Mode** in Toast Web. For more information, see [Future Order Setup - Pickup Mode and Auto Send](https://support.toasttab.com/article/Future-Order-Setup-Pickup-Mode-and-Auto-Send). You can choose to:
