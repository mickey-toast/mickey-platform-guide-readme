...
excerpt: >-
  Certain cash drawer actions available on the Toast POS device are also
  available on Toast Web. You can complete the following cash drawer actions
  from Toast Web:
hidden: false
metadata:
  description: >-
...
**To complete a cash drawer action in Toast Web**
...
3. Go to the cash drawer you want to complete an action for. Scroll down to the **Cash entries** row and select the **View** link to view the **Cash entries** table.
...
**To complete a cash in action**

1. On the **Cash drawer history** page, go to the **Update entries** dropdown menu.
...
**To complete a cash drop action**
...
**To complete a close cash drawer action**
...
**To complete a adjust starting balance action**

1. On the **Cash drawer history** report page, go to the **Update entries** dropdown menu.
...
**To complete an update closing balance action**
...
**To configure your cash drawer variance thresholds**
