...
excerpt: >-
  Cash drawers are physically attached to printers. When employees perform
  actions that require cash transactions, the Toast platform opens the cash
  drawer.
hidden: false
metadata:
  description: >-
...
You can assign a cash drawer name when you [create or update a cash drawer](https://doc.toasttab.com/doc/platformguide/adminCashDrawerSetup.html#adminCashDrawerCreate) with the **Finance > Related > Settings > Printers & cash drawers** page in Toast Web.
