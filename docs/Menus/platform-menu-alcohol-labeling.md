...
excerpt: >-
  The details page for each menu item or modifier has a Does this item contain
  alcohol setting, under the Properties section. This setting identifies whether
  the menu item or…
hidden: false
metadata:
  description: >-
    The details page for each menu item or modifier has a Does this item contain
    alcohol setting, under the Properties section. This setting identifies
    whether the menu item or…
---
