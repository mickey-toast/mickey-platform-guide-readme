...
excerpt: >-
  Menu entities do not inherit their visibility settings from their parents. For
  example, a menu item does not inherit the visibility settings that are
  configured for its parent…
hidden: false
metadata:
  description: >-
    Menu entities do not inherit their visibility settings from their parents.
    For example, a menu item does not inherit the visibility settings that are
    configured for its parent…
---
