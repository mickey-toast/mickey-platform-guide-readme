...
excerpt: >-
  The first step in using portions is to create the portions themselves, for
  example, 1st Half and 2nd Half. You can use a portion's Price Multiplier
  setting to alter the price…
hidden: false
metadata:
  description: >-
    The first step in using portions is to create the portions themselves, for
