...
hidden: false
metadata:
  description: 'When pricing the menu items in a menu group, you can choose to either:'
---

When pricing the menu items in a menu group, you can choose to either:

- [Set a price on the menu group and then configure the group's menu items to inherit that price.](https://doc.toasttab.com/doc/platformguide/adminPricingMenuItems.html#adminSettingPricesAtTheMenuGroupLevel)
- [Price the menu items in the group individually.](https://doc.toasttab.com/doc/platformguide/adminPricingMenuItems.html#adminSettingPricesOnIndividualMenuItems)
...
For both approaches, you can choose to use either a [pricing strategy](https://doc.toasttab.com/doc/platformguide/adminPricingStrategies.html), such as base price, menu-specific price or time-specific price, or you can use a [price level](https://doc.toasttab.com/doc/platformguide/adminUsingPriceLevels.html) to set your prices.
...
The **Items** section on a menu group details page displays the menu items contained in the menu group. Menu items that inherit their price from the menu group display "inherited" in the **Price** column. A menu item that does not display "inherited" in the **Price** column is priced individually. Also, when the menu group has items that are priced individually, a message appears in the **Pricing** section that says "Some of this group's items do not inherit pricing". You can select the **Show** button in that message to view a list of individually priced items.
...
**To set a menu group-level price**
...
4. Select the menu group's name to view its details page.
...
6. Set the pricing for the menu group. You can choose a pricing strategy ([Base Price](https://doc.toasttab.com/doc/platformguide/adminBasePrice.html), [Size Price](https://doc.toasttab.com/doc/platformguide/adminSizePrice.html), [Time Specific Price](https://doc.toasttab.com/doc/platformguide/adminTimeSpecificPrice.html), [Open Price](https://doc.toasttab.com/doc/platformguide/adminOpenPrice.html)) or use [price levels](https://doc.toasttab.com/doc/platformguide/adminUsingPriceLevels.html).
7. Save your changes.
...
8. To configure a menu item to inherit its price from its parent menu group:
   ...
   - In the **Items** section of the menu group details page, select a menu item name to view its details page.
...
9. To configure a menu item to override the menu group's price with its own individual price:
   ...
   - Set the price for the menu item. You can choose a pricing strategy ([Base Price](https://doc.toasttab.com/doc/platformguide/adminBasePrice.html), [Size Price](https://doc.toasttab.com/doc/platformguide/adminSizePrice.html), [Menu Specific Price](https://doc.toasttab.com/doc/platformguide/adminMenuSpecificPrice.html), [Time Specific Price](https://doc.toasttab.com/doc/platformguide/adminTimeSpecificPrice.html), [Open Price](https://doc.toasttab.com/doc/platformguide/adminOpenPrice.html), [Location Specific Price](https://doc.toasttab.com/doc/platformguide/adminLocationSpecificPrice.html)) or use [price levels](https://doc.toasttab.com/doc/platformguide/adminUsingPriceLevels.html).
...
10. [If you are done editing prices for your menus, publish your changes.](https://doc.toasttab.com/doc/platformguide/adminNoteAboutPublishingPrices.html)
...
**To set prices on individual menu items**
...
6. In the **Items** section, select a menu item's name to view its details page.
...
11. [If you are done editing prices for your menus, publish your changes.](https://doc.toasttab.com/doc/platformguide/adminNoteAboutPublishingPrices.html)
