...
excerpt: >-
  This section provides information on working with change sets in the menu
  manager:
hidden: false
metadata:
  description: >-
...
- [Editing a menu manager change set](https://doc.toasttab.com/doc/platformguide/platformWorkingWithMenuManagerChangeSets.html#platformEditingAMenuManagerChangeSet)
- [Resolving errors for menu manager change sets](https://doc.toasttab.com/doc/platformguide/platformWorkingWithMenuManagerChangeSets.html#platformResolvingErrorsForMenuManagerChangeSets)
...
**To change updates in a menu manager preview page**
...
3. To see the updates for a menu entity, expand its row in the change set preview. You see all of the updates associated with the menu entity.
   ...
   To remove a *specific update*, select the remove button on the update's row. For example, in the illustration below, selecting the remove button for the **Visibility** row removes just the visibility update for the Grilled cheese menu item and leaves the **Price** update.
   ...
   To remove *all updates* for a menu entity, select the remove button on the entity's row. For example, in the illustration below, selecting the remove button for the **Grilled cheese** row removes both the **Visibility** update and the **Price** update.
