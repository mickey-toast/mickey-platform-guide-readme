...
hidden: false
metadata:
  description: 'Applies to: Menu items (including modifier item references)'
---

****Applies to:**** Menu items (including [modifier item references](https://doc.toasttab.com/doc/platformguide/adminPricingModifierOptions.html#adminUnderstandingAModifierOptionsItemReference))
...
> ❗️ Important
>
> If your restaurant has multiple locations, there are additional best practices you should follow when configuring menu-specific prices. For more information, see [Menu-specific prices for multi-location restaurants](https://doc.toasttab.com/doc/platformguide/platformMenuSpecificPricesForMultiLocationRestaurants.html) in the [Multiple restaurant locations](https://doc.toasttab.com/doc/platformguide/sharingMenusAndOtherInformationAmongRestaurants.html) section.
...
On the **Price editor** page, you can also bulk convert prices to menu-specific prices. For more information, see [Using the price editor](https://doc.toasttab.com/doc/platformguide/adminUsingThePriceEditor.html).
