...
excerpt: >-
  You use prep stations to route menu items to the appropriate stations in the
  kitchen for fulfillment. A prep station represents the location of a kitchen
  printer or KDS device…
hidden: false
metadata:
  description: >-
    You use prep stations to route menu items to the appropriate stations in the
