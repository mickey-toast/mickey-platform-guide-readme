...
excerpt: >-
  This section provides procedures and information about creating your menu
  hierarchy.
hidden: false
metadata:
  description: >-
...
- [Create a new menu](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToCreateAMenu).
- [Set the order in which your menus appear in your ordering channels](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToSetMenuDisplayOrder).
- [Edit an existing menu](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToEditAMenu).
- [Remove a menu](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToRemoveAMenu). Removing a menu removes any menu groups and menu items that the menu contains.

**To create a menu**

1. [Access the menu builder](https://doc.toasttab.com/doc/platformguide/adminAccessingTheBasicMenuBuilder.html).
...
5. In the **Pricing and taxes** section, [set the tax rates and other tax behavior](https://doc.toasttab.com/doc/platformguide/adminAssigningTaxRatesInMenuBuilder.html) for this menu.
6. In the **Kitchen prep** section, use the **Prep stations** settings to [assign the prep stations](https://doc.toasttab.com/doc/platformguide/adminAssigningPrepStationsMenuBuilder.html) for this menu.
7. In the **Kitchen prep** section, use the **Course** setting to [specify the course](https://doc.toasttab.com/doc/platformguide/adminAssigningCourses.html) for this menu.
8. In the **Reporting** section, [select a sales category](https://doc.toasttab.com/doc/platformguide/adminAssigningSalesCategories.html) for this menu from the **Sales category** menu.
9. In the **Availability** section, specify the days and times that this menu is available for ordering. By default, **Always** is selected, meaning the menu is available during all hours that the restaurant is open. Use the **Specific days and time** setting to [set a custom schedule for when the menu is available](https://doc.toasttab.com/doc/platformguide/adminSpecifyingACustomScheduleForAMenu.html).

   For multi-location restaurants, the time period you specify is in each location's local time.
10. In the **Channel visibility** section, [select the ordering channels where this menu is visible](https://doc.toasttab.com/doc/platformguide/adminSpecifyingOrderingChannelVisibility.html). A menu is available for ordering on the channels where it is visible.
11. Select **Save**.
12. Select the **X** icon in the upper-left corner to return to the menu builder home page.
13. [Add menu groups and subgroups to your menu](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminWorkingWithMenuGroups).
...
4. Select **Save**.
5. If you are ready for guests and employees to see these menu changes, select **Publish all changes**, then select **Publish** again in the **Confirm Publish** dialog. See [Understanding when to publish your menu](https://doc.toasttab.com/doc/platformguide/adminUnderstandingWhenToPublishYourMenu.html) for more information.
...
6. If you are ready for guests and employees to see these menu changes, select **Publish all changes**, then select **Publish** again in the **Confirm Publish** dialog. See [Understanding when to publish your menu](https://doc.toasttab.com/doc/platformguide/adminUnderstandingWhenToPublishYourMenu.html) for more information.
...
You can also access a menu group from a menu's details page. To do so, [navigate to the details page for the menu](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToEditAMenu), select **Menu groups** from the left-hand pane, and then select the menu group's name.
...
- [Create a menu group](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToCreateAMenuGroup)
- [Create a subgroup](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToCreateASubgroup)
- [Configure a menu group or subgroup](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToConfigureAMenuGroupOrSubgroup)
- [Edit a menu group](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToEditAMenuGroup)
- [Edit a subgroup](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToEditASubgroup)
- [Remove a menu group](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToRemoveAMenuGroup)
- [Remove a subgroup](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToRemoveASubgroup)
...
4. [Configure the menu group as needed](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToConfigureAMenuGroupOrSubgroup).
5. Select **Save**.
6. Select the **X** icon in the upper-left corner to return to the menu builder home page.
7. If you are ready for guests and employees to see these menu changes, select **Publish all changes**. Select **Publish** again in the **Confirm Publish** dialog. See [Understanding when to publish your menu](https://doc.toasttab.com/doc/platformguide/adminUnderstandingWhenToPublishYourMenu.html) for more information.
...
3. [Configure the subgroup as needed](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToConfigureAMenuGroupOrSubgroup).
4. Select **Save**.
5. Select the **X** icon in the upper-left corner to return to the menu builder home page.
6. If you are ready for guests and employees to see these menu changes, select **Publish all changes**. Select **Publish** again in the **Confirm Publish** dialog. For more information, see [Understanding when to publish your menu](https://doc.toasttab.com/doc/platformguide/adminUnderstandingWhenToPublishYourMenu.html).

**To configure a menu group or subgroup**
...
3. In the **Subgroups** section, you can [add subgroups](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToCreateASubgroup) to further organize the items in this menu group.
4. In the **Items** section, use the **Add new** and **Add existing** buttons to add [new](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToQuicklyCreateNewMenuItemsUsingTheItemsTable) or [existing](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToAddAnExistingMenuItem) items to this menu group.
5. In the **Modifier groups** section, use the **Add new** and **Add existing** buttons to add [new](https://doc.toasttab.com/doc/platformguide/adminAddingModifierGroupsAndModifiers.html#adminCreatingANewModifierGroup) or [existing](https://doc.toasttab.com/doc/platformguide/adminAddingModifierGroupsAndModifiers.html#adminAddingAnExistingModifierGroupToAMenuGroupOrItem) modifier groups to this menu group.
6. In the **Kitchen prep** section, use the **Prep stations** settings to [assign the prep stations](https://doc.toasttab.com/doc/platformguide/adminAssigningPrepStationsMenuBuilder.html) for this menu group.
7. In the **Kitchen prep** section, use the **Course** setting to [specify the course](https://doc.toasttab.com/doc/platformguide/adminAssigningCourses.html) for this menu group.
8. In the **Reporting** section, [select a sales category](https://doc.toasttab.com/doc/platformguide/adminAssigningSalesCategories.html) for this menu group from the **Sales category** menu.
9. In the **Taxes** section, [set the tax rates and other tax behavior](https://doc.toasttab.com/doc/platformguide/adminAssigningTaxRatesInMenuBuilder.html) for this menu group.
10. In the **Channel visibility** section, [select the ordering channels where this menu group is visible](https://doc.toasttab.com/doc/platformguide/adminSpecifyingOrderingChannelVisibility.html). A menu group is available for ordering on the channels where it is visible.
11. Select **Save**.
12. Select the **X** icon in the upper-left corner to return to the menu builder home page.
13. If you are ready for guests and employees to see these menu changes, select **Publish all changes**, then select **Publish** again in the **Confirm Publish** dialog. For more information, see [Understanding when to publish your menu](https://doc.toasttab.com/doc/platformguide/adminUnderstandingWhenToPublishYourMenu.html).
...
5. Select the **X** icon in the upper-left corner to return to the menu builder home page.
6. If you are ready for guests and employees to see these menu changes, select **Publish all changes**, then select **Publish** again in the **Confirm Publish** dialog. For more information, see [Understanding when to publish your menu](https://doc.toasttab.com/doc/platformguide/adminUnderstandingWhenToPublishYourMenu.html).
...
5. If you are ready for guests and employees to see these menu changes, select **Publish all changes**, then select **Publish** again in the **Confirm Publish** dialog. For more information, see [Understanding when to publish your menu](https://doc.toasttab.com/doc/platformguide/adminUnderstandingWhenToPublishYourMenu.html).
...
- [Create menu items using the **Items** table](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToQuicklyCreateNewMenuItemsUsingTheItemsTable).
- [Access a menu item's details page where you can specify all of a menu item's configuration settings](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToAccessAMenuItemsDetailsPageAndProvideAdditionalMenuItemConfiguration).
- [Add an existing menu item](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToAddAnExistingMenuItem).
- [Edit a menu item](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToEditAMenuItem).
- [Move a menu item to a different menu group](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToMoveAMenuItemToADifferentMenuGroup).
- [Remove a menu item](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToRemoveAMenuItem). Note that removing a menu item also removes any modifier groups assigned to that menu item.

**To create new menu items using the Items table**

1. On the details page for the [menu group](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToEditAMenuGroup) or [subgroup](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToEditASubgroup) you want to add items to, select **Items**.
...
6. Select **Save**.
   ...
   > 📘 Note
   >
   > All menu items in the table must have a name and a base price in order to save the table. If you have incomplete rows, delete them before saving. Also, if you want to provide additional configuration for the menu item beyond a name and base price, you must save it before you can [access its details page](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToAccessAMenuItemsDetailsPageAndProvideAdditionalMenuItemConfiguration).
7. Select the **X** icon in the upper-left corner to return to the menu builder home page.
8. If you are ready for guests and employees to see these menu changes, select **Publish all changes**, then select **Publish** again in the **Confirm Publish** dialog. For more information, see [Understanding when to publish your menu](https://doc.toasttab.com/doc/platformguide/adminUnderstandingWhenToPublishYourMenu.html).

**To access a menu item's details page and provide additional menu item configuration**

1. On the details page for the [menu group](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToEditAMenuGroup) or [subgroup](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToEditASubgroup) that contains the menu items you want to edit, select **Items** to view the **Items** table.
...
3. In the **Item details** section:
   ...
   - [Add an image](https://doc.toasttab.com/doc/platformguide/adminAddingImagesToMenuItems.html) to the menu item.
   ...
   - If the menu item contains alcohol and requires additional handling after it is ordered (for example, an ID check or the prevention of loyalty point accruals), select **Yes** from the **Does this item contain alcohol?** menu. For more information on alcohol labeling, see [Assigning alcohol labeling to menu items](https://doc.toasttab.com/doc/platformguide/adminAssigningAlcoholLabelingToMenuItemsMenuBuilder.html).
4. Select the stock dropdown list, next to the menu item's name, to open the item's stock settings, where you can [specify the item's stock status and count](https://doc.toasttab.com/doc/platformguide/adminSettingInventoryStatusForMenuItems.html).
...
5. In the **Pricing** section, enter a price for the menu item:
   ...
   - To enter size prices, choose the **Size** pricing strategy and enter a price for each size.
      ...
      You cannot save a menu item if it has empty size price rows, so delete any empty rows after you are done entering your prices. For detailed instructions, see [Using advanced pricing strategies for menu items](https://doc.toasttab.com/doc/platformguide/adminUsingAdvancedPricingStrategiesForMenuItemsMenuBuilder.html).
...
7. In the **Modifier groups** section, you can add [new](https://doc.toasttab.com/doc/platformguide/adminAddingModifierGroupsAndModifiers.html#adminCreatingANewModifierGroup) or [existing](https://doc.toasttab.com/doc/platformguide/adminAddingModifierGroupsAndModifiers.html#adminAddingAnExistingModifierGroupToAMenuGroupOrItem) modifier groups directly to this menu item.

   You can also specify that the menu item [inherits modifier groups](https://doc.toasttab.com/doc/platformguide/adminAddingModifierGroupsAndModifiers.html#adminInheritingMenuGroupsFromParentMenuGroup) that are assigned to its parent menu groups.
...
9. In the **Kitchen > Prep stations** section, you specify the prep stations this menu item is sent to when it is ordered. By default, a menu item inherits its prep stations from a parent menu entity. A parent menu entity can be a menu, menu group, or subgroup.
   ...
   For more information, see [Assigning prep stations](https://doc.toasttab.com/doc/platformguide/adminAssigningPrepStationsMenuBuilder.html).
10. In the **Kitchen > Courses** section, you specify the courses assigned to this menu item. By default, a menu item inherits its course from a parent menu entity. A parent menu entity can be a menu, menu group, or subgroup.
   ...
   For more information, see [Assigning courses](https://doc.toasttab.com/doc/platformguide/adminAssigningCourses.html).
11. In the **Reporting > Sales category** section, you specify the sales category assigned to this menu item. By default, a menu item inherits its sales category from a parent menu entity. A parent menu entity can be a menu, menu group, or subgroup.
   ...
   For more information, see [Assigning sales categories](https://doc.toasttab.com/doc/platformguide/adminAssigningSalesCategories.html).
12. In the **Tax settings** section, you set the tax rates and other tax behavior for this menu item. By default, a menu item inherits its tax rates and tax behavior from a parent menu entity. A parent menu entity can be a restaurant, menu, menu group, or subgroup.
   ...
   For more information, see [Assigning tax rates and tax behavior](https://doc.toasttab.com/doc/platformguide/adminAssigningTaxRatesInMenuBuilder.html).
13. In the **Time-based ordering rules** section, you can specify rules for your online orders:
   ...
   For more information, see [Setting time-based ordering rules for online orders](https://doc.toasttab.com/doc/platformguide/platformSettingTimeBasedOrderingRulesForOnlineOrders.html).
14. In the **Channel visibility** section, [select where this menu item is visible](https://doc.toasttab.com/doc/platformguide/adminSpecifyingOrderingChannelVisibility.html). A menu item is available for ordering on the channels where it is visible.
15. Select **Save**.
16. Select the **X** icon in the upper-left corner to return to the menu builder home page.
17. If you are ready for guests and employees to see these menu changes, select **Publish all changes**, then select **Publish** again in the **Confirm Publish** dialog. For more information, see [Understanding when to publish your menu](https://doc.toasttab.com/doc/platformguide/adminUnderstandingWhenToPublishYourMenu.html).

**To add an existing menu item**

1. On the details page for the [menu group](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToEditAMenuGroup) or [subgroup](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToEditASubgroup) you want to add an existing item to, select **Items**.
2. Do one of the following:
...
11. If you are ready for guests and employees to see these menu changes, select **Publish all changes**, then select **Publish** again in the **Confirm Publish** dialog. For more information, see [Understanding when to publish your menu](https://doc.toasttab.com/doc/platformguide/adminUnderstandingWhenToPublishYourMenu.html).

**To edit a menu item**

1. On the details page for the [menu group](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToEditAMenuGroup) or [subgroup](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToEditASubgroup) that contains the menu item you want to edit, select **Items**.
...
1. On the details page for the [menu group](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToEditAMenuGroup) or [subgroup](https://doc.toasttab.com/doc/platformguide/adminCreatingYourMenuHierarchy.html#adminToEditASubgroup) that contains the menu item you want to remove, select **Items**.
