...
excerpt: >-
  You can set the stock status for menu items to indicate whether a menu item is
  in stock, out of stock, or in limited supply. Out of stock items are displayed
  to your guests,…
hidden: false
metadata:
  description: >-
    You can set the stock status for menu items to indicate whether a menu item
    is in stock, out of stock, or in limited supply. Out of stock items are
    displayed to your guests,…
---
