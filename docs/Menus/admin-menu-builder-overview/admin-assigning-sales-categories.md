...
excerpt: >-
  The Sales Summary and other Toast reports use sales categories to create a
  breakdown of your sales, organized by sales category, for example, Food,
  Drinks, Retail, and so on.
hidden: false
metadata:
  description: >-
    The Sales Summary and other Toast reports use sales categories to create a
