...
excerpt: >-
  When you are creating a new modifier in a bulk import, you are actually
  creating a menu item that functions as the modifier's item reference. In the
  advanced template, the rows…
hidden: false
metadata:
  description: >-
    When you are creating a new modifier in a bulk import, you are actually
