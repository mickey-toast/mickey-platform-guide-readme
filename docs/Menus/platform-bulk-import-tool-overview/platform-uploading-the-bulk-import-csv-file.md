...
excerpt: >-
  Once you have filled out your copy of a bulk import spreadsheet and downloaded
  it as a CSV file, you can upload the CSV file into the Toast platform. This
  section provides…
hidden: false
metadata:
  description: >-
    ...
    platform. This section provides…
---
...
6. Select **Submit**.
   ...
   For more information about resolving data validation and import operation failures, see [Fixing import failures](https://doc.toasttab.com/doc/platformguide/platformFixingImportFailures.html).
