...
excerpt: >-
  An important task in operating a restaurant is keeping track of the inventory
  of your restaurant's menu items. If the inventory of a menu item starts to run
  low or goes out of…
hidden: false
metadata:
  description: >-
    ...
    starts to run low or goes out of…
---
