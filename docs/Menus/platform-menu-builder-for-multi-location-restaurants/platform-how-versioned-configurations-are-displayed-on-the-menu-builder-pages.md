...
excerpt: >-
  When you configure a menu or a menu item, many settings require you to choose
  other configuration entities. For example, when configuring a menu, you
  specify the menu groups…
hidden: false
metadata:
  description: >-
    When you configure a menu or a menu item, many settings require you to
    choose other configuration entities. For example, when configuring a menu,
    you specify the menu groups…
---
