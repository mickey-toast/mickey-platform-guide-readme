...
excerpt: >-
  As you create your enterprise's configuration in Toast Web, you should
  consider the individual configuration entities you are creating, what your
  enterprise's requirements are,…
hidden: false
metadata:
  description: >-
    As you create your enterprise's configuration in Toast Web, you should
...
- Menu-related entities
   ...
   - Menu items, modifiers (see [Versioning menu items](https://doc.toasttab.com/doc/platformguide/versioningOfMenuItems.html) for more information)
   - Open items
   - Portions
   - Pre-modifiers
   - Sales categories
...
![](https://doc.toasttab.com/doc/media/tax_rates_auto_created.PNG)
...
![](https://doc.toasttab.com/doc/media/tax_rates_masters_only.png)
...
- [Taxes](https://doc.toasttab.com/doc/platformguide/adminCreatingMasterTaxRates.html)
- [Prep Stations](https://doc.toasttab.com/doc/platformguide/managingPrepStationsAndPrintersForEnterprises.html)
...
- Menus, menu groups, and modifier groups (see [Versioning at the menu group and modifier group level](https://doc.toasttab.com/doc/platformguide/versioningAtTheMenuGroupAndModifierGroupLevel.html) for more information)
- Price levels
- Courses
- Dining options
...
For more information on printer set up, see [Prep stations and printers for enterprises](https://doc.toasttab.com/doc/platformguide/managingPrepStationsAndPrintersForEnterprises.html).
