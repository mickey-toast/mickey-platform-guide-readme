...
excerpt: >-
  The You are viewing menu allows you to filter the page you are viewing to show
  versions of configuration entities that are used by the restaurant groups
  and/or locations you…
hidden: false
metadata:
  description: >-
    The You are viewing menu allows you to filter the page you are viewing to
    show versions of configuration entities that are used by the restaurant
    groups and/or locations you…
---
...
![](https://doc.toasttab.com/doc/media/select_restaurants_rest_group.PNG)
...
![](https://doc.toasttab.com/doc/media/select_restaurants_individual_location.PNG)
