...
excerpt: >-
  You can use restaurant groups to group locations that share a concept. For
  example, some of your locations may have a grill and others may not. You can
  add the locations that…
hidden: false
metadata:
  description: >-
    You can use restaurant groups to group locations that share a concept. For
...
![](https://doc.toasttab.com/doc/media/conceptual_restaurant_group.png)
