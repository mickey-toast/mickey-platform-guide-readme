...
excerpt: >-
  Multi-factor authentication (MFA) is a secure authentication method where you
  are asked to provide additional details to further secure your Toast account.
  The following list…
hidden: false
metadata:
  description: >-
    Multi-factor authentication (MFA) is a secure authentication method where
    you are asked to provide additional details to further secure your Toast
    account. The following list…
---
...
**To reset multi-factor authentication**
