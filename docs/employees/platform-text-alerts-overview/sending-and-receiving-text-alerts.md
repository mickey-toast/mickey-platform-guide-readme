...
excerpt: This section describes how to send a text alert from a Toast POS device.
hidden: false
metadata:
  description: This section describes how to send a text alert from a Toast POS device.
---
