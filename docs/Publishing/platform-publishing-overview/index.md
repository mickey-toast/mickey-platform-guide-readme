---
title: Publishing updates to POS location configuration
excerpt: >-
  To make configuration changes available to the Toast API and Toast platform,
  you might need to publish them after you save them.
hidden: false
metadata:
  description: >-
    To make configuration changes available to the Toast API and Toast platform,
...
For example, you might add a new item to a menu or change menu prices. When you save those changes, they are not reflected on Toast POS devices or in Toast API results until you publish them.
