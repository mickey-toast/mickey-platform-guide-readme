...
excerpt: >-
  During offline mode, employees can clock in on Toast POS devices and perform
  many tasks, such as taking orders. Employees may also be able to clock out,
...
The [Shift Review](https://doc.toasttab.com/doc/platformguide/adminUiOptionsReference.html#confShiftReview) option affects how employees can clock out at the end of their shifts:
