...
excerpt: >-
  The job-based access setting allows you to configure an employee’s permissions
  based on their clocked-in job. This ensures the correct level of permissions
  for your employee…
hidden: false
metadata:
  description: >-
    The job-based access setting allows you to configure an employee’s
    permissions based on their clocked-in job. This ensures the correct level of
    permissions for your employee…
---
