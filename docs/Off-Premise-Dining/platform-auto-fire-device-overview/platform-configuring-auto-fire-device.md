...
excerpt: To configure an Autofire device in Toast Web
hidden: false
metadata:
  description: To configure an Autofire device in Toast Web
---

> 📘 Note
>
> Only one device should be configured as an Autofire device to avoid [double printing](https://support.toasttab.com/article/Double-Printing?utm_campaign=toast-community&utm_medium=toastweb&utm_source=web). Toast support recommends the Autofire device be a hardwired terminal that is likely to remain logged into the Toast POS app throughout the entirety of your online ordering hours.

**To configure an Autofire device in Toast Web**
...
**To change your Autofire device in Toast Web**
...
For more information about how to set up autofiring, see [Setting up Order Auto-Firing](https://support.toasttab.com/article/How-do-I-ensure-scheduled-orders-and-online-orders-fire-automatically-to-the-kitchen-1492811100407#using_thresholds_and_minimums).

**To configure a device to Autofire in the Toast POS app**
...
4. Select the **Save** button to save your changes.
   ...
   > 📘 Note
   >
   > The Autofire device cannot be part of a device group. For more information about device groups, see [Device Groups](https://support.toasttab.com/article/Device-Groups).
