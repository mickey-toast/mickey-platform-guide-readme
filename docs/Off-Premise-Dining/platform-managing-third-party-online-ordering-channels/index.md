...
excerpt: >-
  ...
  channels such as DoorDash™, Grubhub™, and Uber Eats™. You can choose to turn
  on, off, or snooze (pause)…
hidden: false
metadata:
  description: >-
    The Toast platform integrates with various third-party online ordering
...
> 📘 Note
>
> To access third-party online ordering configuration settings, you must have the **6.6 Restaurant Operations Setup** permission. For more information about permissions, see [Web setup access permissions](https://doc.toasttab.com/doc/platformguide/adminPermissions.html#adminWebSetupAccessPermissions).
...
**To turn on, off, or snooze ordering from a third-party online ordering channel**
