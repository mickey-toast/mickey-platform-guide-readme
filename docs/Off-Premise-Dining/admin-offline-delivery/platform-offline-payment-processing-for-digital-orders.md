...
excerpt: >-
  During a payment processor outage, the Toast platform can still accept orders
  placed through the Local by Toast app or the Toast Online Ordering website.
  Credit card payments…
hidden: false
metadata:
  description: >-
    During a payment processor outage, the Toast platform can still accept
    orders placed through the Local by Toast app or the Toast Online Ordering
