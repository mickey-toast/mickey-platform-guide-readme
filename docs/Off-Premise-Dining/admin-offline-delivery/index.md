...
excerpt: >-
  You can place takeout and delivery orders when the device is in offline mode.
  However, you cannot look up guest information to link the order to an existing
  guest account. If…
hidden: false
metadata:
  description: >-
    You can place takeout and delivery orders when the device is in offline
    mode. However, you cannot look up guest information to link the order to an
    existing guest account. If…
---
