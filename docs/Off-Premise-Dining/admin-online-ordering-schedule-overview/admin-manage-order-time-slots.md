...
excerpt: >-
  The online ordering schedule you configure in Toast Web determines the
  earliest and latest times in a business day when guests can place online
  orders. The available times are…
hidden: false
metadata:
  description: >-
    The online ordering schedule you configure in Toast Web determines the
...
**Example 1: First online ordering slot**
...
**Example 2: Last online ordering slot**
