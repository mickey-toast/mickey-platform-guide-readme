...
excerpt: >-
  On the online ordering dashboard, you can quickly access settings to control
  your order volume and online ordering availability during peak times. From the
  dashboard, you can:
hidden: false
metadata:
  description: >-
    On the online ordering dashboard, you can quickly access settings to control
    your order volume and online ordering availability during peak times. From
...
**To access your restaurant's online ordering dashboard**
...
After you make your selection, a colored label is added to the top of the dashboard. The label shows what selection was applied. For example, if you choose to snooze for 20 minutes at 10:00 AM, the label will show that online ordering is snoozed until 10:20 AM. If online ordering is enabled, the label displays your online ordering availability based on your configured [online ordering hours](https://doc.toasttab.com/doc/platformguide/adminConfigureOnlineOrderingHoursOverview.html). Your changes are automatically saved and published.

### Throttling delays for takeout orders

You can also add throttling delays for takeout orders from the online ordering dashboard. A throttling delay puts a hold on or pauses online orders. For more information, see [Online Ordering: Advanced Settings](https://support.toasttab.com/article/Online-Ordering-Advanced-Settings#throttling).

The takeout [quote time](https://support.toasttab.com/article/Managing-Your-Quote-Time-Strategy) that is displayed is the same time configured under **Quote time strategy**in Toast Web. Changes to the takeout quote time are automatically updated on the dashboard.

**To add a delay for takeout orders**

1. Select the **Takeout** drop-down menu. From the menu, make your selection. You can choose to delay by 5 minute increments up to 120 minutes.
...
2. Select the **Publish all changes** button to save your changes.
...
> 📘 Note
>
> The delivery setting also appears as an icon on the dashboard. Select the icon to display the delivery setting.

**To turn off TDS or first-party delivery**
...
**To turn on TDS or first-party delivery**

1. Toggle the **Delivery** button from **Off** to **On**. This enables delivery on the **Delivery** page.

   If you have TDS configured, the new delivery time is the takeout quote time plus DoorDash delivery time. [TDS uses the Takeout quote time](https://support.toasttab.com/article/How-is-the-delivery-time-for-Toast-Delivery-Services-determined-for-the-guest) and adds the additional DoorDash delivery time.
2. Select the **Publish all changes** button to save your changes.

**To add a delay for first-party delivery orders**
...
1. Select the **Delivery** drop-down menu. From the menu, make your selection. You can choose to delay by 5 minute increments up to 120 minutes.
