...
excerpt: >-
  To configure a combo discount to only include some of the menu items in a menu
  group, you can add a separate combo group for each individual menu item
  permutation of the…
hidden: false
metadata:
  description: >-
    To configure a combo discount to only include some of the menu items in a
    menu group, you can add a separate combo group for each individual menu item
    permutation of the…
---
