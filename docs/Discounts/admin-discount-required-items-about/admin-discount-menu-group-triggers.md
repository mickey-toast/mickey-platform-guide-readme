...
excerpt: >-
  When you search for an item for a discount, the results include matching
  items, menu groups, and menus.
hidden: false
metadata:
  description: >-
    When you search for an item for a discount, the results include matching
...
For more information about discount required item combinations, see [Configuring groups of required items](https://doc.toasttab.com/doc/platformguide/adminDiscountsCombiningTriggers.html).

For more information about configuring discounts for menu groups that have size pricing or different prices, see [Combination pricing and menu groups](https://doc.toasttab.com/doc/platformguide/adminCombinationPricingAndMenuGroups.html) and [Handling menu groups with varying prices](https://doc.toasttab.com/doc/platformguide/adminDiscountsMenuGroupsVaryingPrices.html).
