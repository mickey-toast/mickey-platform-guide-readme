...
excerpt: >-
  You can configure minimum and maximum check total thresholds for any type of
  discount. These thresholds determine if a discount can be applied to a check,
  based on the pre-tax…
hidden: false
metadata:
  description: >-
    You can configure minimum and maximum check total thresholds for any type of
    discount. These thresholds determine if a discount can be applied to a
    check, based on the pre-tax…
---
...
**To configure minimum and maximum check totals for a discount**
