...
excerpt: >-
  To manage the partner integrations that have access to your restaurant in the
  Toast platform, you use the Integrations section in Toast Web. For example,
  you might use an…
hidden: false
metadata:
  description: >-
    To manage the partner integrations that have access to your restaurant in
    the Toast platform, you use the Integrations section in Toast Web. For
...
The Toast Restaurant Management Suite gives you access to a large number of integration partners. You can add an integration to a Toast POS location using the **My Integrations** page in Toast Web..
...
3. Find the integration partner you want to add, and select **Add Now**.
...
4. If you have multiple locations, use the **Select Locations** drop-down to select which restaurants you want to add the integration to, and select **Apply**.
5. If necessary, on the **Add Partner** page, select **Confirm**.
6. Choose **Integrations > Integration management > Configure integrations** to open the **My integrations** page.
7. Next to the integration you added, select the gear icon. A pop-up window opens.
...
For more information about adding integrations, see [this Toast Support article](https://support.toasttab.com/article/Adding-or-Removing-an-Integration-with-Toast-Partner-Connect).
