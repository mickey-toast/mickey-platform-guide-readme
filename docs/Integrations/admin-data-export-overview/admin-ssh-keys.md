...
title: SSH keys
excerpt: >-
  Toast sFTP data exports require the use of a public SSH key. Use the below
  sections to learn how to generate public SSH keys, and where to place them
  within Toast Web.
hidden: false
metadata:
  description: >-
...
1. Go to **Reports > Settings > SSH Keys**.

   ![](https://doc.toasttab.com/doc/media/nav_ssh_keys.png)
2. Select **Add new key**.

   ![](https://doc.toasttab.com/doc/media/new_ssh_key.png)
3. Enter your SSH key in the text box and select **Add key**. When pasting your SSH key, include the "=" and everything before; do not include the device name after the "=".
   ...
   ![](https://doc.toasttab.com/doc/media/add_key_ssh.png)

   After your SSH key is added to Toast Web, you can continue with [downloading data export files.](https://doc.toasttab.com/doc/platformguide/downloading_data_export_files.html)
