...
excerpt: >-
  You can change a menu item's inventory status in Quick Edit mode on the Toast
  POS device. This method is especially useful for quickly 86ing a menu item
  that has suddenly gone…
hidden: false
metadata:
  description: >-
    You can change a menu item's inventory status in Quick Edit mode on the
    Toast POS device. This method is especially useful for quickly 86ing a menu
    item that has suddenly gone…
---
