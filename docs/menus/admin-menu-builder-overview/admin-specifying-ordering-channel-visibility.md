...
excerpt: >-
  The details page for each menu, menu group, subgroup, menu item, or modifier
  group has a Channel visibility section that shows the channels where the menu
  entity is visible. If…
hidden: false
metadata:
  description: >-
    The details page for each menu, menu group, subgroup, menu item, or modifier
    group has a Channel visibility section that shows the channels where the
    menu entity is visible. If…
---
...
This additional control over visibility is currently restricted to menus. It is not yet available for menu groups, menu items, modifier groups, or [modifier option item references](https://doc.toasttab.com/doc/platformguide/adminPricingModifierOptions.html#adminUnderstandingAModifierOptionsItemReference).
