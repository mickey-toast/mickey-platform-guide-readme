...
excerpt: >-
  To view the Orders or Order details report, you must have the Restaurant Admin
  > Sales Reports permission.
hidden: false
metadata:
  description: >-
    To view the Orders or Order details report, you must have the Restaurant
    Admin > Sales Reports permission.
---
...
4. To update the results based on the new filter values, select **Update**.
...
To change the column used to sort the **Orders** report or the **Menu item summary**, select the column heading that you want to sort by. To reverse the sort order, select the column heading again.

You cannot sort the order details panes in the **Order details** report. The order details panes are always sorted in descending order by the opened date.
