...
excerpt: >-
  The order fulfillment process is how the order items are received by the
  restaurant, sent to the kitchen, prepared, and provided to the guest.
hidden: false
metadata:
  description: >-
    The order fulfillment process is how the order items are received by the
...
3. The kitchen staff prepares the order. For more information about order preparation, see [Kitchen operations and fulfillment](https://doc.toasttab.com/doc/platformguide/adminAddPrepStation.html).
