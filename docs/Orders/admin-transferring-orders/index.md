...
excerpt: >-
  When a restaurant employee places an order for a guest, the the order and its
  checks are assigned to that employee.
hidden: false
metadata:
  description: >-
    When a restaurant employee places an order for a guest, the the order and
    its checks are assigned to that employee.
---
...
: [Access "mode" permissions](https://doc.toasttab.com/doc/platformguide/adminPermissions.html#adminModePermissions) provide access to the areas of the Toast POS app where the check transfer options are located.
...
: The [Bulk Transfer Checks](https://doc.toasttab.com/doc/platformguide/adminPermissions.html#permissionBulkTransferChecks) permission allows you to [select and transfer multiple checks](https://doc.toasttab.com/doc/platformguide/adminTransferringOrders.html#platformOrdersTransferMultiple).
...
******Change Server******
: The [Change Server](https://doc.toasttab.com/doc/platformguide/adminPermissions.html#permissionChangeServer) permission allows you to [select and transfer a single check or order](https://doc.toasttab.com/doc/platformguide/adminTransferringOrders.html#platformOrdersTransferSingle).
  If you do not have this permission, you can ask another restaurant employee who does have this permission to enter their POS access code or swipe their access card.
...
**To select and transfer multiple checks**
...
**To change the server for a single order or check**
