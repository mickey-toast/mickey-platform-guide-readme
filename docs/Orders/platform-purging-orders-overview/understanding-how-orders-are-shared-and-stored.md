...
excerpt: >-
  To understand the performance information provided in this section, it is
  helpful to have a basic understanding of how Toast platform orders are shared
  and stored.
hidden: false
metadata:
  description: >-
    To understand the performance information provided in this section, it is
    helpful to have a basic understanding of how Toast platform orders are
    shared and stored.
---
