...
excerpt: >-
  For a combo discount, you configure the discount value and the eligible
...
For more information about selecting required items for discounts, see [Choosing the required items for a discount](https://doc.toasttab.com/doc/platformguide/adminDiscountRequiredItemsAbout.html).
...
For more information about required items for discounts, see [Choosing the required items for a discount](https://doc.toasttab.com/doc/platformguide/adminDiscountRequiredItemsAbout.html).

### Setting the maximum quantity to apply the discount to

You can configure a combo discount as a bulk discount, which includes the minimum and maximum quantity to apply the discount to. See [Bulk discounts](https://doc.toasttab.com/doc/platformguide/adminBulkDiscounts.html).
