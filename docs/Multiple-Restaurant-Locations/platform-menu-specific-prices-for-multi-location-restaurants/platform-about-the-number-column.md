...
excerpt: >-
  For multi-location restaurants, a Number column is added the Menu Prices
  table. This additional column appears in the Menu Prices table on a menu
  item's details page:
hidden: false
metadata:
  description: >-
