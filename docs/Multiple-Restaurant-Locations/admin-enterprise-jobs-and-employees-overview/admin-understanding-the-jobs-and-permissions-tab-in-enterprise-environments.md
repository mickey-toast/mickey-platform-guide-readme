...
excerpt: >-
  The Jobs and Permissions tab on the employee details page has two sections,
  the Jobs section and the Access Permissions section. These two sections are
...
- Samuel Server has [restaurant access](https://doc.toasttab.com/doc/platformguide/adminAssigningRestaurantAccess.html) to both the Boston and Burlington locations.
