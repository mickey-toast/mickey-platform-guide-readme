...
excerpt: >-
  You use restaurant groups and sub-groups to organize your locations into a
  hierarchy. For example, you could group locations by geographic area or by
  franchise owner or by some…
hidden: false
metadata:
  description: >-
    You use restaurant groups and sub-groups to organize your locations into a
...
![](https://doc.toasttab.com/doc/media/groups_subgroups_locations.png)
