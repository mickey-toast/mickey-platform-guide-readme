...
title: Targets
excerpt: >-
  When you create a version of a configuration entity, you specify a target. The
  target dictates which locations have access to that version of the entity.
  When you set a…
hidden: false
metadata:
  description: >-
    When you create a version of a configuration entity, you specify a target.
    The target dictates which locations have access to that version of the
    entity. When you set a…
---
...
![](https://doc.toasttab.com/doc/media/targets_and_the_hierarchy.png)
