...
excerpt: >-
  When you create a version of a configuration entity, you specify an owner. An
  owner is a restaurant group or location. Users who have access permissions to
  that restaurant…
hidden: false
metadata:
  description: >-
    When you create a version of a configuration entity, you specify an owner.
    An owner is a restaurant group or location. Users who have access
    permissions to that restaurant…
---
...
![](https://doc.toasttab.com/doc/media/owners_and_the_hierarchy.png)
