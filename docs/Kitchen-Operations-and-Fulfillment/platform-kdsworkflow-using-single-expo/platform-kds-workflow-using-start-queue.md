...
excerpt: >-
  The restaurant in this example uses KDS devices using start queue. For more
  information about start queue, see Start queue overview.
hidden: false
metadata:
  description: >-
    The restaurant in this example uses KDS devices using start queue. For more
...
The restaurant in this example uses KDS devices using start queue. For more information about start queue, see [Start queue overview](https://doc.toasttab.com/doc/platformguide/platformKdsStartQueue.html#platformKdsStartQueueOverview).

This example restaurant configuration:

- Uses [individual item fulfillment](https://doc.toasttab.com/doc/platformguide/adminKitchenDiningRoomReference.html#configFulfillItems).
- [Sends prep station items](https://doc.toasttab.com/doc/platformguide/adminKitchenDiningRoomReference.html#configSendTo) to prep station and expediter KDS devices.
