...
excerpt: >-
  Certain types of items and prep stations do not need to use kitchen tickets to
  facilitate fulfillment. In these situations, you can prevent tickets from
  being printed. You can…
hidden: false
metadata:
  description: >-
    Certain types of items and prep stations do not need to use kitchen tickets
    to facilitate fulfillment. In these situations, you can prevent tickets from
    being printed. You can…
---
...
**To set up a virtual prep station and route menu items to it**

1. [Add a prep station](https://doc.toasttab.com/doc/platformguide/adminAddPrepStation.html).

   - Name the prep station **No Print**.
   - Set the **Send to** setting to **Prep station only**.
...
2. Verify that all prep station KDS devices do not have the ****No Print**** prep station [assigned](https://doc.toasttab.com/doc/platformguide/adminAssignPrepStationKDS.html).
3. [Assign the ****No Print**** prep station to menu items](https://doc.toasttab.com/doc/platformguide/adminRoutingToPrepStations.html#adminAssignPrepStationMenu).
...
**To set up a Toast POS device to not print tickets at a specific prep station**

1. [Add the printer](https://doc.toasttab.com/doc/platformguide/adminAddKitchenPrinter.html).
2. [Add the prep station](https://doc.toasttab.com/doc/platformguide/adminAddPrepStation.html).

   - Name the prep station.
   - Set the **Send to** setting to either **Prep station only** or **Prep station and expediter** as needed.

      > 📘 Note
      >
      > Other Toast POS devices still need to be able to send items to the Toast POS device that does not print it's own tickets.
...
3. [Assign the prep station to menu items](https://doc.toasttab.com/doc/platformguide/adminRoutingToPrepStations.html#adminAssignPrepStationMenu).
...
5. On the prep station Toast POS device that you do not want to print tickets from, [access the Toast POS Device Setup screen](https://doc.toasttab.com/doc/platformguide/adminConfigureDevice.html).
