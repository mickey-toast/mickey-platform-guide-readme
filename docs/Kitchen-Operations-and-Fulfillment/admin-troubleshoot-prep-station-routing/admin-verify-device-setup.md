...
excerpt: >-
  For a Toast KDS device to receive the correct orders, it must be set up for
  the correct prep station or expediter seat. In addition, you can limit the
  tickets shown on a device…
hidden: false
metadata:
  description: >-
    For a Toast KDS device to receive the correct orders, it must be set up for
