...
excerpt: >-
  An assembly line is created using prep stations that are then moved into the
  correct sequence. Before you create an assembly line, make sure that:
hidden: false
metadata:
  description: >-
    An assembly line is created using prep stations that are then moved into the
...
- You [created prep stations](https://doc.toasttab.com/doc/platformguide/adminAddPrepStation.html).
...
After you verify that these prerequisites are complete, you can create the assembly line and then assign the [assembly line to the relevant menus, menu groups, and menu items](https://doc.toasttab.com/doc/platformguide/platformKDSRoutingUsingAssemblyLines.html#platformKDSAssignAssemblyLinesToMenuEntities).
...
The following procedure is for creating an assembly line for a single-restaurant location. For information about how to create assembly lines for multi-location restaurants, see [Assembly lines for multi-location restaurants](https://doc.toasttab.com/doc/platformguide/platformKDSCreatingAssemblyLines.html#platformKDSCreatingAssemblyLinesMultiLocation).
...
Assembly lines use versioning and targets for multi-location restaurants. The following procedure is for creating an assembly line for a multi-location restaurant. For information about versions, see [Versions](https://doc.toasttab.com/doc/platformguide/versions.html). For information about targets, see [Targets](https://doc.toasttab.com/doc/platformguide/targets.html).
