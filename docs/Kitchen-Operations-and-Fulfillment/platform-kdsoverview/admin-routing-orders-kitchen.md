...
excerpt: >-
  At its core, a kitchen display system (KDS) device is like a kitchen printer:
  it relies on the values that you define for your menu items and modifiers. To
  help label and route…
hidden: false
metadata:
  description: >-
    At its core, a kitchen display system (KDS) device is like a kitchen
    printer: it relies on the values that you define for your menu items and
    modifiers. To help label and route…
---
