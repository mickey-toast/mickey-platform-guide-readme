...
excerpt: >-
  Toast data exports give you access to your Toast POS data. Data exports are
  configured to run automatically or can be downloaded manually, and can include
  the following data types:
hidden: false
metadata:
  description: >-
    Toast data exports give you access to your Toast POS data. Data exports are
    configured to run automatically or can be downloaded manually, and can
