...
excerpt: >-
  The refund process allows you to issue refunds to guests. The process is
  available from the Toast POS and Toast Web.
hidden: false
metadata:
  description: >-
    The refund process allows you to issue refunds to guests. The process is
...
1. Go to **Employees > Employee management > Employees**.
