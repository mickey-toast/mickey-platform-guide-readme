...
excerpt: >-
  You can void items in an order until a payment is captured. After the payment
  is captured, you must refund the payment on the items.
hidden: false
metadata:
  description: >-
    You can void items in an order until a payment is captured. After the
    payment is captured, you must refund the payment on the items.
---
