...
excerpt: >-
  In high volume restaurants with a lot of orders, the number of orders each
  device must maintain in memory can have an impact on performance. As a
  solution to this issue, you…
hidden: false
metadata:
  description: >-
    In high volume restaurants with a lot of orders, the number of orders each
...
> 📘 Note
>
> Toast is phasing out device groups and instead recommending restaurants use service area, dining option, or revenue center configurations to segment their restaurant operations. For more information, see this [Toast Support article](https://support.toasttab.com/article/Device-Groups).
...
![](https://doc.toasttab.com/doc/media/device-groups-without-device-groups.png)
...
![](https://doc.toasttab.com/doc/media/device-groups-with-device-groups.png)
...
![](https://doc.toasttab.com/doc/media/device-groups-device-group-name.png)
