...
hidden: false
metadata:
  description: 'House account invoices have one of the following statuses:'
---
...
**To create a house account invoice**

1. [Access Toast Web](https://doc.toasttab.com/doc/platformguide/adminAccessToastAdminBackend.html).
2. Go to **Finance > Payments > House accounts > Accounts** to open the **Accounts** page.
...
6. On the **New invoice** page, you can view and access the following links:
...
7. On the **New invoice** page, you can customize your invoice:
   ...
   - From the **Customer** link:
      ...
      - Edit your guest information:
         ...
         ![Shows the Customer link with the Save recipients button emphasized in Toast Web.](https://doc.toasttab.com/doc/media/platform-house-accounts-add-email.png)
   ...
   - From the **Order** link:
      ...
      - View, add, or delete items in the invoice or adjust your invoice balance:
         ...
         - To view the items in your invoice, select the down arrow next to the check number. This displays all the items in your check.
            ...
            ![Shows the items in a check on the Order link in Toast Web.](https://doc.toasttab.com/doc/media/platform-house-accounts-view-items.png)
      ...
      - Mark order as tax exempt: Select the checkbox to exclude taxes from the invoice. If you choose to make the order tax-exempt, you cannot add a discount.
         ...
         - **Add tax exemption ID**: Add a tax exemption ID. For more information, see this [Toast Support article](https://support.toasttab.com/article/How-to-run-a-Tax-Exempt-transaction-1492809352212).
      - Add a service charge to the invoice. To add a service charge, select the **+ Add service charge** link to open the **Add a service charge** dialog. In the **Add a service charge** dialog, select the service charge and then the **Add service charges** button to add the charge to the invoice. For more information, see [Configuring service charges](https://doc.toasttab.com/doc/platformguide/adminServiceChargeCreate.html).
   ...
   - From the **Payment schedule** link:
      ...
      - Configure how and when you want your guests to pay their invoices:
         ...
         - Choose to prompt guests to authorize the location to charge their payment card for future payments.
...
In the **Invoices** section, choose the invoice with a **DRAFT** status and select the invoice link to open the **Invoice** page. Complete the workflow from the [Creating a house account invoice](https://doc.toasttab.com/doc/platformguide/platformManageHouseAccounts.html#platformCreateHouseAccountInvoice) section.
...
**To create bulk invoices**

1. [Access Toast Web](https://doc.toasttab.com/doc/platformguide/adminAccessToastAdminBackend.html).
2. Go to **Finance > Payments > House accounts** to open the **House accounts** page.
3. On the left pane, select the **Bulk invoices** link. This opens the **Bulk invoices** page.
4. On the **Bulk invoices** page, you can view the **Overview** table. The **Overview** table displays the following information:
...
8. To review the invoices, select the invoice to open the **Preview invoices [date]** page. On the **Preview invoices [date]** page, you can view the following information:
   ...
   - House account information:
      ...
      - Invoice amount
      - Invoice status
      - Saved card-on-file information
...
10. Select the **Send invoices** button to send the invoices. This opens the **Bulk invoices** page. The status of the invoice changes from **DRAFT COMPLETE** to **SENDING**.
   ...
   If your customers have saved cards on file, you can select the invoice to open the **Preview invoices [date]** page and select the **Charge [number of] saved cards on file** button. This opens the **Confirm saved card on file payments** page where you can charge the invoice amount to the saved cards. Select the **Process [number of] payments** button to process the invoice amount.
